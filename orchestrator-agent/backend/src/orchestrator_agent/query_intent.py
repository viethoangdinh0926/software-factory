...
USER_MESSAGE_FIRST_RULES = (
    ...
    "3. If they asked to change this service's artifact, apply it this turn.\n"
    ...
    "7. Do not start a new interview or re-introduce this step as if this were "
    "the first turn. Do not stall with 'I need more information' or 'tell me more'. "
    "Reply as a continuation of this conversation.\n"
)
