"""Thorough feature / functionality interview before API type or stack."""
...
def discuss_features_for(
    ...
    result = invoke_json(
        system=(
            ...
            "The architect package only sketches this microservice. Before any API type, "
            "API design, or tech stack, run a thorough interactive feature interview for "
            "THIS service only.\n"
            ...
            "Do not propose API type, endpoints, or a tech stack in this step.\n"
